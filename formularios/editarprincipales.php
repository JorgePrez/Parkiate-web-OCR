...
$query= "UPDATE parqueo SET nombre_empresa='$nombre', direccion='$direccion', capacidad_maxima='$capacidad_maxima', media_hora=$media_hora, hora=$hora , dia=$dia, mes= $mes WHERE id_parqueo = '$id_parqueo'";
